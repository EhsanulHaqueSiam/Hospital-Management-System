...
function addPatient($patient)
{
    ...
    $sql = "INSERT INTO patients (user_id, date_of_birth, blood_group, address, emergency_contact, medical_history) 
            VALUES ('{$patient['user_id']}', '{$date_of_birth}', '{$blood_group}', '{$address}', '{$emergency_contact}', '{$medical_history}')";
...
function updatePatient($patient)
{
    ...
    $sql = "UPDATE patients SET date_of_birth='{$date_of_birth}', blood_group='{$blood_group}', address='{$address}', 
